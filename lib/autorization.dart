          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(onPressed: () {Navigator.pushNamed(context, "/pages");}, child: Text('Войти', style:TextStyle(color: Color.fromRGBO(0, 0, 0, 1), fontWeight: FontWeight.bold) , ) ),
                Align(
